...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260420101230_AddPublicCalendarAndSubscriptions")]
    partial class AddPublicCalendarAndSubscriptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CalendarSubscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("CalendarId")
                        .HasDatabaseName("ix_calendar_subscriptions_calendar_id");

                    b.HasIndex("UserId", "CalendarId")
                        .IsUnique()
                        .HasDatabaseName("ix_calendar_subscriptions_user_id_calendar_id");
            ...
            modelBuilder.Entity("Domain.Entities.CalendarSubscription", b =>
                {
                    b.HasOne("Domain.Entities.Calendar", "Calendar")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_calendar_subscriptions_calendars_calendar_id");
